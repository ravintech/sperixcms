...
<!-- first row -->
	<div class="row" style="margin: 5px;">
		<p><a href="?home" style="color: #7a1e21;"><span class="glyphicon glyphicon-home"></span> Home</a> &nbsp; <span class="glyphicon glyphicon-forward"></span> &nbsp; <a href="#" style="color: #7a1e21;"><span class="glyphicon glyphicon-envelope"></span> Articles</a></p> 
	</div>
	<div class="row" style="margin: 5px;">
	<br/>
	</div>
