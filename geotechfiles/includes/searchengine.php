...
<!-- first row -->
	<div class="row" style="margin: 5px;">
		<p><a href="?home" style="color: <?php echo $theme[2]; ?>;"><span class="glyphicon glyphicon-home"></span> Home</a> &nbsp; <span class="glyphicon glyphicon-forward"></span> &nbsp; <a href="?news" style="color: <?php echo $theme[2]; ?>;"><span class="glyphicon glyphicon-search"></span> Search</a></p> 
	</div>
	<div class="row" style="margin: 5px;">
	<br/>
	</div>
