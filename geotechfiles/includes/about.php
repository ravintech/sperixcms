...
<!-- first row -->
	<div class="row" style="margin: 5px;">
		<p><a href="?home" style="color: #7a1e21;"><span class="glyphicon glyphicon-home"></span> Home</a> &nbsp; <span class="glyphicon glyphicon-forward"></span> &nbsp; <a href="?about" style="color: #7a1e21;"><span class="glyphicon glyphicon-info-sign"></span> About GGS</a></p> 
	</div>

	<div class="row" style="margin: 5px;">
		<center><legend><h3><span class="glyphicon glyphicon-info-sign"></span> About GGS</</h3></legend></center>
	</div>
