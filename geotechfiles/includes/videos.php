...
<!-- main content -->
	<div class="row" style="margin: 5px;">
		<p><a href="?home" style="color: <?php echo $theme[2]; ?>;"><span class="glyphicon glyphicon-home"></span> Home</a> &nbsp; <span class="glyphicon glyphicon-forward"></span> &nbsp; <a href="?videos" style="color: <?php echo $theme[2]; ?>;"><span class="glyphicon glyphicon-facetime-video"></span> Videos</a></p> 
	</div>

	<div class="row" style="margin: 15px;">
		<center><legend><h3><span class="glyphicon glyphicon-facetime-video"></span> Videos</</h3></legend></center>
	</div>
